...
import sys
import os
# Ensure the project root (c:/Sistema/Totalcap) is on sys.path so import 'backend.*' works
# __file__ is backend/alembic/env.py; go up three levels to reach project root
