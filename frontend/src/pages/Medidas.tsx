  ...
  const openModal = (mode: 'create' | 'edit', medida?: Medida) => {
    ...
    if (mode === 'edit' && medida) {
      ...
      setFormData({
        ...
        ativo: medida.ativo,
        id_piso: medida.id_piso ? medida.id_piso.toString() : '',
        tipo: medida.tipo || ''
      });
    } else {
      setCurrentId(null);
                ...
                <div className="premium-master-panel" style={{ background: '#FFFFFF', padding: '1.5rem', borderRadius: '12px', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.1)' }}>
                  ...
                  <div style={{ display: 'flex', gap: '1rem', marginBottom: '1.2rem' }}>
                    ...
                    <div className="form-group" style={{ flex: 1 }}>
                      <label htmlFor="id_piso" style={{ fontWeight: '600', color: '#475569' }}>ID Piso</label>
                      <select
                        className="form-input"
                        id="id_piso"
                    ...
                    <div className="form-group" style={{ flex: 1 }}>
                      <label htmlFor="tipo" style={{ fontWeight: '600', color: '#475569' }}>Tipo</label>
                      <select
                        className="form-input"
                        id="tipo"
                        value={formData.tipo}
