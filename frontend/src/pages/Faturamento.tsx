...
export default function Faturamento() {
  ...
  return (
    <div className="faturamento-container">
      ...
      {activeTab === 'faturas' && (
            <div className="tab-content animate-fade-in">
            <div className="search-section glass-panel fat-search-section">
            <div className="form-group fat-search-group">
              <label><Search size={14} /> Buscar Fatura (Número ou Cliente)</label>
              <div className="fat-inputs-row">
                <input
                  type="text"
                  ...
                  style={{ fontSize: '1.05rem', boxSizing: 'border-box' }}
                />
                <input
                  type="date"
                  className="form-input fat-input"
                ...
                <button
                  ...
                  style={{ whiteSpace: 'nowrap', display: 'flex', alignItems: 'center', boxSizing: 'border-box' }}
                >
                  {faturaLoading ? <span>Buscando...</span> : <><Search size={18} /> <span>Buscar</span></>}
                </button>
              </div>
            </div>
          </div>
